...
doi_target = "https://doi.org/10.24823/nrbge.1986.3458"
...
for filename in os.listdir(folder):
    ...
    if not ("philipson" and "1986" in norm):
        print(f"No Philipson reference found in {filename}")
        continue

    # Find the reference line
    ref_index = None
    for i, line in enumerate(lines):
        if ("Philipson" in line and "(1986" in line):
            ref_index = i
            break
    ...
    print(f"Updated Philipson  1986 reference in {filename}")
